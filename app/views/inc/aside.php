<link rel="stylesheet" href="<?php echo URLROOT; ?>/css/aside.css">  
<link rel="stylesheet" href="<?php echo URLROOT; ?>/css/style.css"> 
<div class="col-2 aside bg-dark text-center" style="height:100vh;"> 
    ...
    <a href="<?php echo URLROOT ?>/dashboard"> 
        <button class="w-75  p-2 btn btn-dark mt-3">
    ...
    <a href="<?php echo URLROOT ?>/Ashat">
        <button class="w-75 mt-3 p-2 btn btn-dark">
    ...
    <button class="w-75 mt-3 p-2 btn btn-dark " data-bs-toggle="tooltip" data-bs-placement="right" title="CNSS">CNSS </button>     
