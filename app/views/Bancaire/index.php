...
<head> 
  ...
  <body>   
   ...
   <input type="hidden" id="view" value="<?=URLROOT?>/Bancaire/table">
   <input type="hidden" id="insert" value="<?=URLROOT?>/Bancaire/insert">
   <input type="hidden" id="delete" value="<?=URLROOT?>/Bancaire/delete">
   <input type="hidden" id="edit" value="<?=URLROOT?>/Bancaire/edit"> 
